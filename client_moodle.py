        ...
        for gp1, gp2 in zip(self.chromosome, par2.chromosome):
            ...
            if prob < 0.5:
                if prob < 0.15:
                    ...
                    # else:
                    gene=gp1+random.uniform(-1.0e-14,1.0e-14)
                    # gene=gp1*random.uniform(0.90,1.1)
                    # else:
                ...
                if prob < 0.65:
                    ...
                    # else:
                    gene=gp2+random.uniform(-1.0e-14,1.0e-14)
                    # gene=gp2*random.uniform(0.90,1.1)
                    # else:
                    #     random_float=random.uniform(5,15)
...
def main():
    ...
    first_individual=[-8.573713357380733, 9.463989020391502, -6.425890799027568, 0.05061989627841074, 0.03752776488094509, 9.08842853271178e-05, -5.8620626645677824e-05, -1.1979447095671353e-07, 3.387956969926435e-08, 3.5330522190915224e-11, -6.5304585773639865e-12]
    population = []
